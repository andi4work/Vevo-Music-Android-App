...
import com.friedfishapps.justplay.businessobjects.YouTube.GetVideosDetailsByIDs;
import com.friedfishapps.justplay.businessobjects.YouTube.POJOs.YouTubeChannel;
import com.friedfishapps.justplay.businessobjects.YouTube.POJOs.YouTubeChannelInterface;
import com.friedfishapps.justplay.businessobjects.YouTube.POJOs.YouTubeVideo;
import com.friedfishapps.justplay.businessobjects.YouTube.Tasks.GetVideoDescriptionTask;
import com.friedfishapps.justplay.businessobjects.YouTube.Tasks.GetYouTubeChannelInfoTask;
import com.friedfishapps.justplay.businessobjects.YouTube.VideoStream.StreamMetaData;
...
import com.friedfishapps.justplay.businessobjects.db.Tasks.CheckIfUserSubbedToChannelTask;
import com.friedfishapps.justplay.businessobjects.db.Tasks.IsVideoBookmarkedTask;
import com.friedfishapps.justplay.businessobjects.interfaces.GetDesiredStreamListener;
import com.friedfishapps.justplay.businessobjects.interfaces.YouTubePlayerFragmentInterface;
import com.friedfishapps.justplay.gui.activities.MainActivity;
import com.friedfishapps.justplay.gui.businessobjects.MobileNetworkWarningDialog;
import com.friedfishapps.justplay.gui.businessobjects.PlayerViewGestureDetector;
import com.friedfishapps.justplay.gui.businessobjects.ResumeVideoTask;
import com.friedfishapps.justplay.gui.businessobjects.SkyTubeMaterialDialog;
import com.friedfishapps.justplay.gui.businessobjects.adapters.CommentsAdapter;
import com.friedfishapps.justplay.gui.businessobjects.fragments.ImmersiveModeFragment;
import com.friedfishapps.justplay.gui.businessobjects.views.ClickableLinksTextView;
import com.friedfishapps.justplay.gui.businessobjects.views.SubscribeButton;
import hollowsoft.slidingdrawer.OnDrawerOpenListener;
import hollowsoft.slidingdrawer.SlidingDrawer;

import static com.friedfishapps.justplay.gui.activities.YouTubePlayerActivity.YOUTUBE_VIDEO_OBJ;
...
public class YouTubePlayerV2Fragment extends ImmersiveModeFragment implements YouTubePlayerFragmentInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_youtube_player_v2, container, false);
