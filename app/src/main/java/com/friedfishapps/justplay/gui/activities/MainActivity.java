...
import com.friedfishapps.justplay.businessobjects.db.SearchHistoryDb;
import com.friedfishapps.justplay.businessobjects.db.SearchHistoryTable;
import com.friedfishapps.justplay.businessobjects.interfaces.SearchHistoryClickListener;
import com.friedfishapps.justplay.gui.businessobjects.MainActivityListener;
import com.friedfishapps.justplay.gui.businessobjects.YouTubePlayer;
import com.friedfishapps.justplay.gui.businessobjects.adapters.SearchHistoryCursorAdapter;
import com.friedfishapps.justplay.gui.businessobjects.updates.UpdatesCheckerTask;
import com.friedfishapps.justplay.gui.fragments.ChannelBrowserFragment;
import com.friedfishapps.justplay.gui.fragments.MainFragment;
import com.friedfishapps.justplay.gui.fragments.PlaylistVideosFragment;
import com.friedfishapps.justplay.gui.fragments.SearchVideoGridFragment;

/**
 * Main activity (launcher).  This activity holds {@link com.friedfishapps.justplay.gui.fragments.VideosGridFragment}.
 */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_share:
                ...
                String shareBody = "HD videos!\nDownload the app now & Enjoy↓↓↓\n\nhttps://play.google.com/store/apps/details?id=video.fire.player";
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "BEST APP FOR ALL VIDEOS");
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, shareBody);
                startActivity(Intent.createChooser(sharingIntent, "Share this app using ↓↓↓"));
                return true;
